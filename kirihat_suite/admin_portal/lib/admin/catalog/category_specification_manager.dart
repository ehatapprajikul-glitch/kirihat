...
class _CategorySpecificationManagerState extends State<CategorySpecificationManager> {
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildSectionPreviewItem('1', 'General Specifications', 'Brand, Model, Material, Color...'),
                  _buildSectionPreviewItem('2', 'Physical Attributes', 'Dimensions, Weight, Finish...'),
                  _buildSectionPreviewItem('3', 'Usage & Care', 'Recommended Usage, Cleaning Instructions...'),
                  _buildSectionPreviewItem('4', 'Warranty & Services', 'Warranty, Replacement Policy...'),
                ],
              ),
            ),
          ],
  ...
  void _seedDefaultSections() {
    final defaultFields = <SpecificationField>[
      // General Specifications (order: 1)
      SpecificationField(
        ...
        sectionOrder: 1,
        isRequired: true,
        helpText: 'Select appropriate category.',
        displayOrder: 0,
      ),
      SpecificationField(
        fieldName: 'Brand',
        ...
        sectionOrder: 1,
        isRequired: true,
        helpText: 'Enter brand or "Generic".',
        displayOrder: 1,
      ),
      SpecificationField(
        fieldName: 'Model / Design Name',
        fieldType: 'text',
        section: 'General Specifications',
        sectionOrder: 1,
        isRequired: false,
        helpText: 'Enter SKU or design reference.',
        displayOrder: 2,
      ),
      SpecificationField(
        ...
        sectionOrder: 1,
        isRequired: false,
        helpText: 'Describe item type (Cup, Bottle, Decor etc.).',
        displayOrder: 3,
      ),
      SpecificationField(
        fieldName: 'Material',
      ...
      SpecificationField(
        fieldName: 'Pattern / Theme',
        fieldType: 'text',
        section: 'General Specifications',
        sectionOrder: 1,
        isRequired: false,
        helpText: 'Print/design description if any.',
        displayOrder: 6,
      ),
      SpecificationField(
        fieldName: 'Quantity in Pack',
        fieldType: 'number',
        section: 'General Specifications',
        sectionOrder: 1,
        isRequired: false,
        helpText: 'Number of items included.',
        displayOrder: 7,
      ),
      SpecificationField(
        fieldName: 'Sales Package',
        fieldType: 'text',
        section: 'General Specifications',
        sectionOrder: 1,
        isRequired: false,
        helpText: 'List included contents.',
        displayOrder: 8,
      ),

      // Physical Attributes (order: 2)
      SpecificationField(
        ...
        sectionOrder: 2,
        isRequired: false,
        helpText: 'Enter size if available.',
        displayOrder: 9,
      ),
      SpecificationField(
        fieldName: 'Weight',
      ...
      SpecificationField(
        ...
        sectionOrder: 2,
        isRequired: false,
        helpText: 'Glossy / Matte / Textured etc.',
        displayOrder: 11,
      ),
      SpecificationField(
        fieldName: 'Fragility Level',
        fieldType: 'dropdown',
        section: 'Physical Attributes',
        sectionOrder: 2,
        isRequired: false,
        helpText: 'Breakable / Durable / Not Applicable.',
        options: ['Breakable', 'Durable', 'Not Applicable'],
        displayOrder: 12,
      ),

      // Usage & Care (order: 3)
      SpecificationField(
        fieldName: 'Recommended Usage',
        fieldType: 'text',
        section: 'Usage & Care',
        sectionOrder: 3,
        isRequired: false,
        helpText: 'Intended use (Drinkware, Decor, Storage etc.).',
        displayOrder: 13,
      ),
      SpecificationField(
        ...
        sectionOrder: 3,
        isRequired: false,
        helpText: 'Leak proof, Insulated, LED, Handmade etc.',
        displayOrder: 14,
      ),
      SpecificationField(
        fieldName: 'Cleaning Instructions',
        fieldType: 'text',
        section: 'Usage & Care',
        sectionOrder: 3,
        isRequired: false,
        helpText: 'Care guidance if applicable.',
        displayOrder: 15,
      ),

      // Warranty & Services (order: 4)
      SpecificationField(
        fieldName: 'Warranty Summary',
        fieldType: 'text',
        section: 'Warranty & Services',
        sectionOrder: 4,
        isRequired: false,
        helpText: 'Enter warranty if offered.',
        displayOrder: 16,
      ),
      SpecificationField(
        fieldName: 'Replacement Policy',
        fieldType: 'text',
        section: 'Warranty & Services',
        sectionOrder: 4,
        isRequired: false,
        helpText: 'Platform policy duration.',
        displayOrder: 17,
      ),
      SpecificationField(
        fieldName: 'GST Invoice',
        fieldType: 'dropdown',
        section: 'Warranty & Services',
        sectionOrder: 4,
        isRequired: false,
        helpText: 'Availability selection.',
        options: ['Available', 'Not Available'],
        displayOrder: 18,
      ),
      SpecificationField(
        fieldName: 'Cash on Delivery',
        fieldType: 'dropdown',
        section: 'Warranty & Services',
        sectionOrder: 4,
        isRequired: false,
        helpText: 'Seller support indication.',
