        ...
        Container(
          ...
          child: const Column(
            ...
            children: [
              ...
              SizedBox(height: 8),
              Text('• Format: JPG or PNG (White/Transparent background)', style: TextStyle(fontSize: 11)),
              Text('• Size: 800x800px or larger (Square 1:1 preferred)', style: TextStyle(fontSize: 11)),
              Text('• Max size: 2MB per image', style: TextStyle(fontSize: 11)),
            ],
          ),
        ),
