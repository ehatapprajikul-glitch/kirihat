    ...
    try {
      if (_isEditMode) {
        ...
        try {
          ...
          // Initialize seller profile if role is seller
          if (_selectedRole == 'seller') {
             await FirebaseFirestore.instance.collection('sellers').add({
                'user_id': userCredential.user!.uid,
                'business_name': _nameController.text.trim(), // Default to name
                ...
                'approved_by': auth.FirebaseAuth.instance.currentUser?.uid,
             });
          }
