...
/// Enhanced multi-step account deletion flow
...
class _DeleteAccountEnhancedScreenState extends State<DeleteAccountEnhancedScreen> {
  ...
  final List<Map<String, dynamic>> _deletionReasons = [
    {
      ...
      'description': 'Worried about data privacy',
    },
    {
      'title': 'Not Using Anymore',
      'icon': Icons.block_outlined,
      'description': 'Don\'t need the service',
    },
    {
      'title': 'Too Many Notifications',
      'icon': Icons.notifications_off_outlined,
      'description': 'Getting too many alerts',
    },
    {
      'title': 'Found Better Alternative',
      'icon': Icons.compare_arrows_outlined,
      'description': 'Using another service',
    },
    {
  ...
  Future<void> _logDeletionReason() async {
      ...
      child: Column(
        ...
        children: [
          ...
          _buildConsequenceCard(
            ...
            description: 'Your account and all associated data will be permanently deleted and cannot be recovered.',
            color: Colors.red,
          ),
          ...
          _buildConsequenceCard(
            ...
            title: 'Order History',
            description: 'All your past orders, invoices, and purchase history will be erased.',
            color: Colors.orange,
          ),
          ...
          _buildConsequenceCard(
            ...
            description: 'All saved cards and payment information will be removed.',
            color: Colors.blue,
          ),
          ...
          _buildConsequenceCard(
            ...
            description: 'All saved delivery addresses will be deleted.',
            color: Colors.green,
          ),
          ...
          _buildConsequenceCard(
            ...
            title: 'Wishlist & Cart',
            description: 'Your wishlist items and cart will be cleared.',
            color: Colors.pink,
          ),
              ...
              children: [
                ...
                Expanded(
                  child: Padding(
                    ...
                    child: Text(
                      'I understand that this action is permanent and cannot be undone. All my data will be lost forever.',
                      style: TextStyle(
                        fontSize: 14,
          ...
          Container(
            ...
            child: Column(
              children: [
                ...
                const SizedBox(height: 8),
                Text(
                  'You are about to permanently delete your account. This action cannot be reversed under any circumstances.',
                  textAlign: TextAlign.center,
                  style: TextStyle(
                    fontSize: 15,
                    color: Colors.red[900],
          ...
          if (_confirmationController.text.toLowerCase() != 'delete')
            Row(
              children: [
                ...
                Expanded(
                  child: Text(
                    'Please type DELETE (case insensitive) to enable account deletion',
                    style: TextStyle(
                      fontSize: 13,
                      color: Colors.grey[600],
                    ),
            ...
            Expanded(
              ...
              child: ElevatedButton(
                onPressed: _isLoading
                    ? null
                    : _canProceed()
                        ? (_currentStep == 3 ? _deleteAccount : _nextStep)
                        : null,
                style: ElevatedButton.styleFrom(
                ...
                child: _isLoading
                    ...
                    : Text(
                        _currentStep == 3 ? 'DELETE ACCOUNT' : 'Continue',
                        style: const TextStyle(
                          fontSize: 16,
                          fontWeight: FontWeight.bold,
                        ),
